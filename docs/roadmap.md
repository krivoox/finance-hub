...
| 10h | [22-balance-adjustment](./specs/22-balance-adjustment.md) | **KRI-36:** ajuste de saldo/deuda (target → delta → movimiento de auditoría). Tab en Registrar + acción en `/accounts`. No muta `initialBalance`; no es income/expense |
